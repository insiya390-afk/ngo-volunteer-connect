...
<body style="background-color:white;">
	<nav style="box-shadow: 0px 5px 10px rgba(0,0,0,.2);" class="navbar navbar-expand-lg bg-light" style="box-shadow: 0px 5px 10px rgba(0,0,0,.2);">
	...
	<section class="my-5">
		<div class="py-5">
			<h2 class="text-center" style="color:#e40046;font-family:'Roboto',sans-serif;">Login For NGOs</h2>
		</div>
		<div class="w-50 m-auto">

			<div class="w-50 m-auto">
				<div id="msg" style="color: red;" class="text-center"></div>
				<form action="LoginNservlet.do" method="post" name="frm-login"
					id="frm-login">
			...
			<div class="pt-5">
					...
					<a href="registerN.jsp"><p style="color:#e40046;" class="text-center"> Dont have an account?Register NOW!<p class="text-center text-success"></a>
				...
				$.ajax({
					...
					success : function(data, textStatus, jqXHR) {
						...
						if (data.trim() === 'done') {
							...
							window.location.replace("profileN.jsp");
						} else {
