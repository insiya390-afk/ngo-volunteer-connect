...
<body style="background-color:white;">
    <nav class="navbar navbar-expand-lg bg-light" style="box-shadow: 0px 5px 10px rgba(0,0,0,.2);">
      ...
      <br>
      <h2  id="h1" style="color:#e40046;text-align : center; font-family: 'Roboto', sans-serif;">
        Register on our platform to explore and connect!</h2>
    <div class="container">
    <div class="row mt-5">
        <div class="col m-md-5">
                ...
                <div class="card" style="width:400px">
                  ...
                  <div class="card-body">
                    <h4 class="card-title" style="font-family : 'Roboto', sans-serif;">Registration for NGO</h4>
                   
                    <a href="registerN.jsp" style="background-color:#e40046;color:white;" class="btn">Click Here</a>
                  </div>
                </div>
                </div>
                <div class="col m-md-5">
                ...
                <div class="card" style="width:400px">
                  ...
                  <div class="card-body">
                    <h4 class="card-title" style="font-family : 'Roboto', sans-serif;">Registration for Volunteer</h4>
                   
                    <a href="registerV.jsp" style="background-color:#e40046;color:white;" class="btn">Click Here</a>
                  </div>
                </div>
            </div>
        </div>
