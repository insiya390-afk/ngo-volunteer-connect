			...
			<div class="right-side">
				...
				<div class="profile-body">
					<div class="profile-posts tab">
						...
						<div
							style="border: 2px solid black; padding: 2px; background-color: white; width: 750px; margin-left: auto; margin-right: auto; display: block;"
							align="center">
							<h2>
							...
							<button data-target="#mymodal2" data-toggle="modal"
								style="border: 0; padding: 10px; width: 150px; border-radius: 3px; background: var(- -color); color: white; font-family:"
								Bree
								Serif", sans-serif;
	font-size: 1rem;
	margin: 5px 2px;
					...
					<div class="profile-settings tab">
						...
						<div class="card" style="width: 100%;" align="center">
							...
							<div class="card-body">
								...
								<h3 class="card-title"
									style="font-family: 'Roboto', sans-serif;">Update your
									profile</h3>
								<form action="servupdate.do" method="post"
									id="form-update">
									<div class="form-group">
										<label>Change Contact:</label> <input type="text"
											name="contact" id="contact" class="form-control"
											placeholder="leave empty if you dont want to update">
