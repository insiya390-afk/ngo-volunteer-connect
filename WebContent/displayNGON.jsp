...
<body style="padding-top:0px">
	...
	ResultSet rs;
	String ID1 = "", NgoName1 = "", contact1 = "", location1 = "", descr1 = "", image1 = "", email1 = "", achievement1 = "",
			donation1 = "";
	int id1 = 0;
	try {
		...
		if (rs.next()) {
			...
			NgoName1 = rs.getString("NgoName");
			location1 = rs.getString("location");

			contact1 = rs.getString("contact");
			email1 = rs.getString("email");
			descr1 = rs.getString("descr");
			achievement1 = rs.getString("achievement");
			donation1 = rs.getString("donationType");
	...
	<div class="container1" style="padding-top:20px">
		<div class="profile-header">
			<div class="profile-nav-info">
				<h3 class="user-name" style="margin-left: 200px;">Find NGOs</h3>
				<div class="address">
		...
		<div class="main-bd">
			<div class="left-side">
				...
				<div class="profile-side">
					<div class="profile-imgp">
						<img src="images/NGO/<%=image1%>" width="200"
							alt="profile">
					</div>
					<h2 style="text-align:center;"><%=NgoName1%></h2>
					<h3 style="text-align:center;">Registered NGO</h3>
					<p class="mobile-no">
					...
					<div class="user-bio">
						...
						<p class="bio"><%=descr1 %></p>
						<h4>Achievements</h4>
						<p class="bio"><%=achievement1 %></p>
						<h4>Types of donation required</h4>
						<p class="bio"><%=donation1 %></p>
					</div>
			...
			<div class="right-side">
				...
				try {
					...
					pst1 = con1.prepareStatement("select * from ngoproject.ngo");
					...
					while (rs1.next()) {
						...
						NgoName = rs1.getString("NgoName");
						location = rs1.getString("location");

						contact = rs1.getString("contact");
						email = rs1.getString("email");
						descr = rs1.getString("descr");
						achievement = rs1.getString("achievement");
						donation = rs1.getString("donationType");
						image = rs1.getString("image");
						System.out.println(image);
				%>
				<div class="profile-body" style="width: 850px; height: 150px">
					<div class="profile-img">
						<img src="images/NGO/<%=image%>" alt="profile">
					</div>
					<div class="nhead">
						<h2 style="margin-left:50px"><%=NgoName%></h2>
					</div>
					<form action="viewser2" method="post">
						<input id="id" name="id" type="hidden" value=<%=id%>> <input
							id="val" name="val" type="hidden" value=2>
