			...
			<div class="right-side">
				...
				<div class="profile-body">
					<div class="profile-posts tab">
						...
						<div
							style="box-shadow:2px 3px 3px 5px rgba(0,0,0,.2);border: 2px solid black; padding: 2px; background-color: white; width: 750px; margin-left: auto; margin-right: auto; display: block;"
							align="center">
							<h2>
